...
LastEditTime: 2024-10-23 16:02:51
'''
...
class Critic:
    ...
    def network(self):
        ...
        q = Dense(1, activation='linear')(x3)

        return Model([state, action], [q])
    ...
    def train(self, states, actions, critic_target):
        ...
        with tf.GradientTape() as tape:
            ...
            current_Q =self.model([states, actions],training=True)  # pred for this minibatch
            ...
            loss_value = tf.math.reduce_mean(tf.keras.losses.MSE(current_Q, critic_target))
